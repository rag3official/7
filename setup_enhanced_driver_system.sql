...
BEGIN
    ...
    IF EXISTS (
        ...
        RAISE NOTICE 'Made van_number nullable in van_images to fix Slack bot constraints';
    END IF;
END $$;
...
SELECT 
    ...
    -- Calculate upload statistics from actual images
...
SELECT 
    'SUCCESS: Enhanced driver-van image linking system created!' as status,
    'Tables: van_profiles, enhanced van_images, driver_van_assignments' as tables_created,
    'Views: driver_profile_summary, driver_images_with_van_details, van_images_with_driver_details' as views_created,
    'Functions: get_driver_images_by_van, link_images_to_drivers' as functions_created,
...
SELECT 
    'VERIFICATION:' as info,
    COUNT(*) as total_van_profiles 
FROM public.van_profiles;

SELECT 
    'VERIFICATION:' as info,
    COUNT(*) as total_images,
    COUNT(*) FILTER (WHERE driver_id IS NOT NULL) as images_linked_to_drivers
