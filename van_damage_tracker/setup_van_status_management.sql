-- Van Status Management Setup
-- Run this in Supabase Dashboard -> SQL Editor
-- This ensures the van status system is properly configured
...
-- Check if van_profiles table exists and has status field
DO $$
BEGIN
...
-- =============================================================================
-- 2. CREATE STATUS CHANGE AUDIT LOG TABLE (OPTIONAL)
-- =============================================================================
...
-- =============================================================================
-- 3. CREATE TRIGGER TO LOG STATUS CHANGES
-- =============================================================================
...
-- =============================================================================
-- 4. CREATE UPDATED_AT TRIGGER FOR VAN_PROFILES
-- =============================================================================
...
-- Check van status distribution
-- SELECT * FROM van_status_summary;

-- Check if triggers are working (update a van status to test)
-- UPDATE van_profiles SET status = 'maintenance' WHERE van_number = 123;
-- SELECT * FROM recent_status_changes LIMIT 5;
