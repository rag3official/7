-- ========================================
-- VAN DAMAGE TRACKER - COMPLETE DATABASE SETUP
...
-- Step 2: Create drivers table first
...
-- Step 3: Create van_images table
...
-- Step 4: Add current_driver_id to vans table (if it doesn't exist)
...
-- Step 8: Insert sample van images (only if vans exist)
...
-- Step 9: Update existing van_images to link with drivers (if any exist without driver_id)
UPDATE van_images 
SET driver_id = d.id 
FROM drivers d 
...
-- Step 16: Verification queries (optional - uncomment to check results)
...
-- UNION ALL
-- SELECT 'van_images' as table_name, COUNT(*) as count FROM van_images;
...
-- ========================================
-- SETUP COMPLETE!
-- Your database is now ready for the van damage tracker app.
-- ======================================== 