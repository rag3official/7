...
class SupabaseService {
  ...
  Future<List<Van>> getVans() async {
    try {
      ...
      _logger.e('Error getting vans: $e');
      rethrow;
    }
  }
  ...
  Future<Van> createVan(
    ...
    try {
      ...
      _logger.e('Error creating van: $e');
      rethrow;
    }
  }
  ...
  Future<Van> updateVan(String id, Map<String, dynamic> data) async {
    try {
      ...
      _logger.e('Error updating van: $e');
      rethrow;
    }
  }
  ...
  Future<void> deleteVan(String vanId) async {
    try {
      ...
      _logger.e('Error deleting van: $e');
      rethrow;
    }
  }
