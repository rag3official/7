...
def save_van_image_with_damage_analysis(van_id: str, image_data: bytes, van_number: str, 
    ...
    try:
        ...
        record_data = {
            ...
            "description": f"AI Analysis: {analysis_result['damage_description']} | Condition: {analysis_result['condition_rating']}",
        ...
        if response.data:
            ...
            if driver_id:
                update_driver_upload_stats(driver_id, analysis_result['damage_level'])
...
def update_driver_upload_stats(driver_id: str, damage_level: int) -> bool:
    ...
    try:
        ...
        try:
            ...
            logger.info(f"📊 Including upload stats: {current_uploads + 1} total uploads, damage level: {damage_level}")
            ...
            try:
                ...
                if save_success:
                    ...
                    say(f"✅ **Van #{van_number} Image Processed!**\n"
                        ...
                        f"🎯 **Damage assessment saved to database**\n"
                        f"📊 **Driver profile updated with upload stats**")
                else:
...
if __name__ == "__main__":
    try:
        ...
        logger.info("🚀 Starting FIXED DAMAGE ANALYSIS Slack Bot...")
